...
import { 
  ...
  requestShowDetails, 
  requestvideos } from '../api/apiRequests'
...
function MovieID({ mediaType }) {
  ...
  const {data: videos, sendReq: reqVidos} = useApi({
    url: requestvideos(params.showID, mediaType)
  })
  ...
  return (
    <main>
      ...
      <section className='relative w-full h-full pt-[72px]'>
        ...
        <section>
          <Shelf title='Recommendations' fetchURL={requestRecommendations(params.showID, mediaType)}/>
        </section>
